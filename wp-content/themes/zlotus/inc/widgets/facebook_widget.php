...
add_action( 'widgets_init', 'zlotus_facebook_load_widget' );

function zlotus_facebook_load_widget() {
	register_widget( 'zlotus_facebook_widget' );
}

class zlotus_facebook_widget extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'zlotus_facebook_widget', 'description' => __('A widget that displays a Facebook Like Box', 'zlotus') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'zlotus_facebook_widget' );

		/* Create the widget. */
		parent::__construct( 'zlotus_facebook_widget', __('ZLOTUS: Facebook Like Box', 'zlotus'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<!-- Page url -->
		<p>
			<label for="<?php echo $this->get_field_id( 'page_url' ); ?>"><?php esc_html_e( 'Facebook Page URL', 'zlotus' ); ?>:</label>
		...
		<!-- Faces -->
		<p>
			<label for="<?php echo $this->get_field_id( 'faces' ); ?>"><?php esc_html_e( 'Show Faces', 'zlotus' ); ?>:</label>
		...
		<!-- Stream -->
		<p>
			<label for="<?php echo $this->get_field_id( 'stream' ); ?>"><?php esc_html_e( 'Show Stream', 'zlotus' ); ?>:</label>
		...
		<!-- Cover -->
		<p>
			<label for="<?php echo $this->get_field_id( 'cover' ); ?>"><?php esc_html_e( 'Show Page Cover Image', 'zlotus' ); ?>:</label>
