		...
		<div class="sp-container">
			<div class="sp-row">
				<div class="sp-col-12">
					<?php
						if ( is_day() ) :
							echo wp_kses( __( '<span>Daily Archives</span>', 'zlotus' ), array( 'span' => array( 'class' => array() ) ) );
							
							printf( wp_kses( __( '<h1>%s</h1>', 'zlotus' ), array( 'h1' => array( 'class' => array() ) ) ), get_the_date() );

						elseif ( is_month() ) :
						
							
							echo wp_kses( __( '<span>Monthly Archives</span>', 'zlotus' ), array( 'span' => array( 'class' => array() ) ) );
							
							printf( wp_kses( __( '<h1>%s</h1>', 'zlotus' ), array( 'h1' => array( 'class' => array() ) ) ), get_the_date( _x( 'F Y', 'monthly archives date format', 'zlotus' ) ) );
							

						elseif ( is_year() ) :
							
							echo wp_kses( __( '<span>Yearly Archives</span>', 'zlotus' ), array( 'span' => array( 'class' => array() ) ) );
							
							printf( wp_kses( __( '<h1>%s</h1>', 'zlotus' ), array( 'h1' => array( 'class' => array() ) ) ), get_the_date( _x( 'Y', 'yearly archives date format', 'zlotus' ) ) );
							

						else :
							echo wp_kses( __( '<h1>Archives</h1>', 'zlotus' ), array( 'h1' => array( 'class' => array() ) ) );
